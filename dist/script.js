...
var slider = function slider(slides, direction, prev, next) {
  ...
  var slideIndex = 1,
      paused = false;
  var items = document.querySelectorAll(slides); // Функция перелистывающая слайды
  ...
  showSlides(slideIndex); // Функция для перелистывания
  ...
  activateAnimation(); // Запуск функции остановки листания слайдов при наведении мыши
